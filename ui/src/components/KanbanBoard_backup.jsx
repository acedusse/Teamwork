...
function DraggableTask({ task, onTaskAction = null, hasOptimisticUpdate = false }) {
  ...
  const handleActionSelect = (action, actionData = {}) => {
    handleActionsClose();
    if (onTaskAction) {
...
function DroppableColumn({ id, children, column, stats }) {
